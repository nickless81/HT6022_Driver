...
int main(int argc, char *argv[])
{
    ...
    */
    printf("Return value of hantek->setXXX: %d\n", hantek->setXXX(&device,index));
    //setXXX

    printf("Return value of hantek->setCalValues: %d\n", hantek->setCalValues(&device, index, CalValues,HT6022BX_128B));   //Channel 1 input range. Read HT6022.h for more information
    /*
    typedef enum
    {
    ...
    */
    printf("Return value of hantek->setCH1IR: %d\n", hantek->setCH1IR(&device, index, HT6022BX_1V));   //Channel 1 input range. Read HT6022.h for more information

    printf("Return value of hantek->setCH2IR: %d\n", hantek->setCH2IR(&device, index, HT6022BX_1V));   //Channel 2 input range.
    /*
    typedef enum
    {
    ...
    */
    printf("Return value of hantek->setSR: %d\n", hantek->setSR(&device, index, HT6022BX_1MSa)); 	   //100KSa per channel. Read  HT6022.h for more options
    /*
    ...
    */
    ...
    for (int j=0; j<1;j++)
    {
        ...
        printf("Return value of hantek->readData: %d\n", hantek->readData(&device,index, CH1, CH2, HT6022BX_8KB, 0)); //read 1kb of data per channel
